...
<!-- DataTables -->
<script src="/assets/DataTables/datatables.net/js/dataTables.min.js"></script>
<script src="/assets/DataTables/datatables.net-bs5/js/dataTables.bootstrap5.min.js"></script>
<!-- ChartJS -->
